defmodule ReactPhoenix.Decks.Card do
  ...
  def changeset(card, attrs) do
    card
    |> cast(attrs, [:front, :back, :session_interval, :next_session, :successful_session_count, :easiness_factor])
    |> validate_required([:front, :back, :session_interval, :next_session, :successful_session_count, :easiness_factor])
  end
end
